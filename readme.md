...
✔ Integrate defer.js for intelligent lazy-loading of images, iframes, and scripts.
...
For Images:
Use data-src and data-srcset instead of src and srcset, and add the lazyload class:
<img 
...
For Scripts:
Defer non-essential third-party or custom scripts:
